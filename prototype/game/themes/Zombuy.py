...
class Simulation:
    ...
    def items(self):
        return [
            Item(
                "BRAINZ", 25, 100, 15, SalesCalculation(3, 200),
                description="Its not just a brain; its a farm reared, ginger haired M&S brain."
            ),
            Item(
                "Genuine Fake Chinese Brainz", 4, 500, 50, SalesCalculation(3, 1000, -500),
                description="º¤ø,¸¸,ø¤ºº¤ø,¸¸,¸,øºø,¸,ø¤ºº¤ø,¸¸,ø¤HIGHLY RECOMMENDED º."
            ),
            Item(
                "ARMZZZ", 8, 20, 2.0, SalesCalculation(5, 24, -4),
                description="For when your own just wont stay on..."
            ),
            Item(
                "Stapler", 20, 10, 1.4, SalesCalculation(5, 12, -2),
                description="See 'ARMZZZ'."
            ),
            Item(
                "Dr Zomboids Zomball Cure!", 50, 20, 4, SalesCalculation(6, 20, 10),
                description="Got a case of the humans? Make it disappear with just this one easy pill!"
            ),
            Item(
                "Estus Flask", 100, 1, 24, SalesCalculation(10, 2),
            ...
            Item(
                "Dr Zomboids Stay Upper (10 pack)", 5, 100, 6, SalesCalculation(2, 50),
